...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new word("Older Brother", "Bara Bhai", R.drawable.family_older_brother, R.raw.family_older_brother));
        words.add(new word("Younger Brother", "Chota Bhai", R.drawable.family_younger_brother,R.raw.family_younger_brother));
        words.add(new word("Older Sister", "Bari Bhen", R.drawable.family_older_sister, R.raw.family_older_sister));
